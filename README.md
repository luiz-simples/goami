...
```sh
go get -u github.com/luiz-simples/goami/ami
```
...
import (
	...
	"github.com/luiz-simples/goami/ami"
)
...
This projects documentation can be found on godoc at [goami](http://godoc.org/github.com/luiz-simples/goami/ami)
and supports:
...
MIT-LICENSE. See [LICENSE](https://github.com/luiz-simples/goami/blob/master/LICENSE)
